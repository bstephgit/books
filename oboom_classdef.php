...
class OboomDrive extends Drive\Client
{
    ...
    const VERSION = '1'
	const AUTH_URL = "https://www.oboom.com/VERSION/login";
	const TOKEN_URL = "https://api.box.com/oauth2/token";
    const API_URL = "https://api.box.com/2.0";
    const UPLOAD_URL = "https://upload.oboom.com/VERSION/content";
            ...
            return (object) array (
                ...
                'urls' => (object)array('download' => (object)array( 'method' => 'GET', 'url' => self::API_URL.'/files/{fileid}/content' ),
                                'upload' => (object)array( 'method' => 'POST', 'url' => self::UPLOAD_URL ,
                                                    ...
                                                    'body' => (object)array( 'attributes' => (object)array('name'=>'{filename}', 'parent'=> (object)array('id'=>'{parentid}')), 'file' => '{filecontent}' ) ),
